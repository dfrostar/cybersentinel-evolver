...
- Name: pipeline.spec.ts >> CyberSentinel Evolver E2E >> full pipeline: dashboard → scenarios → tournament
- Location: tests/e2e/pipeline.spec.ts:13:3
...
Locator: locator('h1')
Expected: "CyberSentinel Evolver"
Timeout: 5000ms
